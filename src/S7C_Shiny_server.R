  ...
  output$selected_phosphosites <- renderDataTable({
    ...
    phospho_meta %>%
      ...
      mutate(Position = gsub("^.* ", "", Position),
             ...
             Uniprot_ID = paste0("<a href=https://www.uniprot.org/uniprot/", Uniprot_ID,">", Uniprot_ID,"</a>"),
             Gene_names = paste0("<a href=https://www.genecards.org/cgi-bin/carddisp.pl?gene=",Gene_names,">",Gene_names,"</a>"))
  }, escape = FALSE)
